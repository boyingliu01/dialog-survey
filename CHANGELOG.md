...
- Fix empty catch block in `src/services/interview-plan-send.service.ts` (add warn logging instead of silent suppression)
...
- Replace `jest.Mock` with vitest Mock type in `tests/dingtalk-stream.test.ts`
