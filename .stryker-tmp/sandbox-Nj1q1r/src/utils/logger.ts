...
const logger = pino(
  stryMutAct_9fa48('601')
    ...
    : (stryCov_9fa48('601'),
      {
        level: stryMutAct_9fa48('604')
          ? process.env.LOG_LEVEL && 'info'
          : stryMutAct_9fa48('603')
            ? false
            : stryMutAct_9fa48('602')
              ? true
              : (stryCov_9fa48('602', '603', '604'),
                process.env.LOG_LEVEL ||
                  (stryMutAct_9fa48('605') ? '' : (stryCov_9fa48('605'), 'info'))),
        transport: (
              ...
              : stryMutAct_9fa48('606')
                ...
                : (stryCov_9fa48('606', '607', '608'),
                  process.env.NODE_ENV ===
                    (stryMutAct_9fa48('609') ? '' : (stryCov_9fa48('609'), 'development')))
        )
          ? stryMutAct_9fa48('610')
            ? {}
            : (stryCov_9fa48('610'),
              {
                target: stryMutAct_9fa48('611') ? '' : (stryCov_9fa48('611'), 'pino-pretty'),
                options: stryMutAct_9fa48('612')
                  ? {}
                  : (stryCov_9fa48('612'),
                    {
                      colorize: stryMutAct_9fa48('613') ? false : (stryCov_9fa48('613'), true),
                    }),
              })
          : undefined,
      })
