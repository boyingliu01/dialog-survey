...
const TEMPLATES: Record<string, PromptTemplate> = stryMutAct_9fa48('272')
  ? {}
  : (stryCov_9fa48('272'),
    {
      generateQuestion: stryMutAct_9fa48('273')
        ? {}
        : (stryCov_9fa48('273'),
          {
            name: stryMutAct_9fa48('274') ? '' : (stryCov_9fa48('274'), 'generateQuestion'),
            template: stryMutAct_9fa48('275')
              ? ``
              : (stryCov_9fa48('275'),
...
请生成下一个问题，要求简洁、具体。`),
            variables: stryMutAct_9fa48('276')
              ? []
              : (stryCov_9fa48('276'),
                [
                  stryMutAct_9fa48('277') ? '' : (stryCov_9fa48('277'), 'topic'),
                  stryMutAct_9fa48('278') ? '' : (stryCov_9fa48('278'), 'currentQuestion'),
                  stryMutAct_9fa48('279') ? '' : (stryCov_9fa48('279'), 'userAnswer'),
                ]),
          }),
      generateReport: stryMutAct_9fa48('280')
        ? {}
        : (stryCov_9fa48('280'),
          {
            name: stryMutAct_9fa48('281') ? '' : (stryCov_9fa48('281'), 'generateReport'),
            template: stryMutAct_9fa48('282')
              ? ``
              : (stryCov_9fa48('282'),
                `根据以下访谈内容，生成访谈报告。
...
使用中文输出。`),
            variables: stryMutAct_9fa48('283')
              ? []
              : (stryCov_9fa48('283'),
                [
                  stryMutAct_9fa48('284') ? '' : (stryCov_9fa48('284'), 'topic'),
                  stryMutAct_9fa48('285') ? '' : (stryCov_9fa48('285'), 'qaPairs'),
                ]),
          }),
      generateSmartResponse: stryMutAct_9fa48('286')
        ? {}
        : (stryCov_9fa48('286'),
          {
            name: stryMutAct_9fa48('287') ? '' : (stryCov_9fa48('287'), 'generateSmartResponse'),
            template: stryMutAct_9fa48('288')
              ? ``
              : (stryCov_9fa48('288'),
...
**示例输出**：
{
  ...
  "response": "理解您的疑惑。这个访谈是想了解您的工作经历，帮助我们更好地理解您的专业背景。如果您不太想聊这个，我们可以换个话题？"
            ...
            variables: stryMutAct_9fa48('289')
              ? []
              : (stryCov_9fa48('289'),
                [
                  stryMutAct_9fa48('290') ? '' : (stryCov_9fa48('290'), 'conversationHistory'),
                  stryMutAct_9fa48('291') ? '' : (stryCov_9fa48('291'), 'currentQuestion'),
                  stryMutAct_9fa48('292') ? '' : (stryCov_9fa48('292'), 'followupCount'),
                  stryMutAct_9fa48('293') ? '' : (stryCov_9fa48('293'), 'maxFollowups'),
                  stryMutAct_9fa48('294') ? '' : (stryCov_9fa48('294'), 'userAnswer'),
                  stryMutAct_9fa48('295') ? '' : (stryCov_9fa48('295'), 'userName'),
                  stryMutAct_9fa48('296') ? '' : (stryCov_9fa48('296'), 'lastQuestionFlag'),
                ]),
          }),
      analyzeWithDimensions: stryMutAct_9fa48('297')
        ? {}
        : (stryCov_9fa48('297'),
          {
            name: stryMutAct_9fa48('298') ? '' : (stryCov_9fa48('298'), 'analyzeWithDimensions'),
            template: stryMutAct_9fa48('299')
              ? ``
              : (stryCov_9fa48('299'),
...
{"dimensionTags":[{"dimensionId":"...","label":"...","sentiment":"positive|negative|neutral","quotes":["..."]}],"emergentTags":["..."],"interviewerRating":3}`),
            variables: stryMutAct_9fa48('300')
              ? []
              : (stryCov_9fa48('300'),
                [
                  stryMutAct_9fa48('301') ? '' : (stryCov_9fa48('301'), 'dimensions'),
                  stryMutAct_9fa48('302') ? '' : (stryCov_9fa48('302'), 'qaPairs'),
                ]),
          }),
    });
          ...
          stryMutAct_9fa48('306')
            ...
            : stryMutAct_9fa48('305')
              ...
              : stryMutAct_9fa48('304')
                ? true
                : (stryCov_9fa48('304', '305', '306'), templates || TEMPLATES)
        )
      );
    }
  }
        ...
        stryMutAct_9fa48('310')
          ...
          : stryMutAct_9fa48('309')
            ...
            : stryMutAct_9fa48('308')
              ? template
              : (stryCov_9fa48('308', '309', '310'), !template)
      ) {
        if (stryMutAct_9fa48('311')) {
          ...
          throw new Error(
            stryMutAct_9fa48('312')
              ? ``
              : (stryCov_9fa48('312'), `Template not found: ${templateName}`)
          );
        }
      }
      ...
      for (const [key, value] of Object.entries(variables)) {
        if (stryMutAct_9fa48('313')) {
          ...
          result = result.replace(
            new RegExp(
              stryMutAct_9fa48('314') ? `` : (stryCov_9fa48('314'), `{{${key}}}`),
              stryMutAct_9fa48('315') ? '' : (stryCov_9fa48('315'), 'g')
            ),
            value
          );
        }
