...
const logger = pino(
  stryMutAct_9fa48('4012')
    ? {}
    : (stryCov_9fa48('4012'),
      {
        level: stryMutAct_9fa48('4015')
            ...
            : stryMutAct_9fa48('4013')
              ...
              : (stryCov_9fa48('4013', '4014', '4015'),
                process.env.LOG_LEVEL ||
                  (stryMutAct_9fa48('4016') ? '' : (stryCov_9fa48('4016'), 'info'))),
        transport: (
          stryMutAct_9fa48('4019')
            ? process.env.NODE_ENV !== 'development'
            : stryMutAct_9fa48('4018')
              ? false
              : stryMutAct_9fa48('4017')
                ? true
                : (stryCov_9fa48('4017', '4018', '4019'),
                  process.env.NODE_ENV ===
                    (stryMutAct_9fa48('4020') ? '' : (stryCov_9fa48('4020'), 'development')))
        )
          ? stryMutAct_9fa48('4021')
            ? {}
            : (stryCov_9fa48('4021'),
              {
                target: stryMutAct_9fa48('4022') ? '' : (stryCov_9fa48('4022'), 'pino-pretty'),
                options: stryMutAct_9fa48('4023')
                  ? {}
                  : (stryCov_9fa48('4023'),
                    {
                      colorize: stryMutAct_9fa48('4024') ? false : (stryCov_9fa48('4024'), true),
                    }),
              })
          : undefined,
      })
