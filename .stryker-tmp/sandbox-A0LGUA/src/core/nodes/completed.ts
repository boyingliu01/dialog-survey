...
export async function completedNode(
  ...
  if (stryMutAct_9fa48('1139')) {
    ...
    stryCov_9fa48('1139');
    return stryMutAct_9fa48('1140')
      ? {}
      : (stryCov_9fa48('1140'),
        {
          status: stryMutAct_9fa48('1141') ? '' : (stryCov_9fa48('1141'), 'COMPLETED'),
          response: stryMutAct_9fa48('1142')
            ? ''
            : (stryCov_9fa48('1142'),
              '访谈已结束，非常感谢您拨冗参与！您的分享对我们很有价值，祝您一切顺利！'),
          shouldContinue: stryMutAct_9fa48('1143') ? true : (stryCov_9fa48('1143'), false),
        });
  }
}
