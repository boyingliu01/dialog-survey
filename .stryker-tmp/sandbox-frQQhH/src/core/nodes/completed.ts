...
export async function completedNode(
  ...
  if (stryMutAct_9fa48('24')) {
    ...
    stryCov_9fa48('24');
    return stryMutAct_9fa48('25')
      ? {}
      : (stryCov_9fa48('25'),
        {
          status: stryMutAct_9fa48('26') ? '' : (stryCov_9fa48('26'), 'COMPLETED'),
          response: stryMutAct_9fa48('27')
            ? ''
            : (stryCov_9fa48('27'),
              '访谈已结束，非常感谢您拨冗参与！您的分享对我们很有价值，祝您一切顺利！'),
          shouldContinue: stryMutAct_9fa48('28') ? true : (stryCov_9fa48('28'), false),
        });
  }
}
