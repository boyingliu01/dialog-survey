...
const TEMPLATES: Record<string, PromptTemplate> = stryMutAct_9fa48('432')
  ? {}
  : (stryCov_9fa48('432'),
    {
      generateQuestion: stryMutAct_9fa48('433')
        ? {}
        : (stryCov_9fa48('433'),
          {
            name: stryMutAct_9fa48('434') ? '' : (stryCov_9fa48('434'), 'generateQuestion'),
            template: stryMutAct_9fa48('435')
              ? ``
              : (stryCov_9fa48('435'),
...
请生成下一个问题，要求简洁、具体。`),
            variables: stryMutAct_9fa48('436')
              ? []
              : (stryCov_9fa48('436'),
                [
                  stryMutAct_9fa48('437') ? '' : (stryCov_9fa48('437'), 'topic'),
                  stryMutAct_9fa48('438') ? '' : (stryCov_9fa48('438'), 'currentQuestion'),
                  stryMutAct_9fa48('439') ? '' : (stryCov_9fa48('439'), 'userAnswer'),
                ]),
          }),
      generateReport: stryMutAct_9fa48('440')
        ? {}
        : (stryCov_9fa48('440'),
          {
            name: stryMutAct_9fa48('441') ? '' : (stryCov_9fa48('441'), 'generateReport'),
            template: stryMutAct_9fa48('442')
              ? ``
              : (stryCov_9fa48('442'),
                `根据以下访谈内容，生成访谈报告。
...
使用中文输出。`),
            variables: stryMutAct_9fa48('443')
              ? []
              : (stryCov_9fa48('443'),
                [
                  stryMutAct_9fa48('444') ? '' : (stryCov_9fa48('444'), 'topic'),
                  stryMutAct_9fa48('445') ? '' : (stryCov_9fa48('445'), 'qaPairs'),
                ]),
          }),
      generateSmartResponse: stryMutAct_9fa48('446')
        ? {}
        : (stryCov_9fa48('446'),
          {
            name: stryMutAct_9fa48('447') ? '' : (stryCov_9fa48('447'), 'generateSmartResponse'),
...
**示例输出**：
{
  ...
  "response": "理解您的疑惑。这个访谈是想了解您的工作经历，帮助我们更好地理解您的专业背景。如果您不太想聊这个，我们可以换个话题？"
            ...
            variables: stryMutAct_9fa48('449')
              ...
              : (stryCov_9fa48('449'),
                [
                  stryMutAct_9fa48('450') ? '' : (stryCov_9fa48('450'), 'conversationHistory'),
                  stryMutAct_9fa48('451') ? '' : (stryCov_9fa48('451'), 'currentQuestion'),
                  stryMutAct_9fa48('452') ? '' : (stryCov_9fa48('452'), 'followupCount'),
                  stryMutAct_9fa48('453') ? '' : (stryCov_9fa48('453'), 'maxFollowups'),
                  stryMutAct_9fa48('454') ? '' : (stryCov_9fa48('454'), 'userAnswer'),
                  stryMutAct_9fa48('455') ? '' : (stryCov_9fa48('455'), 'userName'),
                  stryMutAct_9fa48('456') ? '' : (stryCov_9fa48('456'), 'lastQuestionFlag'),
                ]),
          }),
      analyzeWithDimensions: stryMutAct_9fa48('457')
        ? {}
        : (stryCov_9fa48('457'),
          {
            name: stryMutAct_9fa48('458') ? '' : (stryCov_9fa48('458'), 'analyzeWithDimensions'),
            template: stryMutAct_9fa48('459')
              ? ``
              : (stryCov_9fa48('459'),
...
{"dimensionTags":[{"dimensionId":"...","label":"...","sentiment":"positive|negative|neutral","quotes":["..."]}],"emergentTags":["..."],"interviewerRating":3}`),
            variables: stryMutAct_9fa48('460')
              ? []
              : (stryCov_9fa48('460'),
                [
                  stryMutAct_9fa48('461') ? '' : (stryCov_9fa48('461'), 'dimensions'),
                  stryMutAct_9fa48('462') ? '' : (stryCov_9fa48('462'), 'qaPairs'),
                ]),
          }),
    });
          ...
          stryMutAct_9fa48('466')
            ...
            : stryMutAct_9fa48('465')
              ...
              : stryMutAct_9fa48('464')
                ? true
                : (stryCov_9fa48('464', '465', '466'), templates || TEMPLATES)
        )
      );
    }
  }
        ...
        stryMutAct_9fa48('470')
          ...
          : stryMutAct_9fa48('469')
            ...
            : stryMutAct_9fa48('468')
              ? template
              : (stryCov_9fa48('468', '469', '470'), !template)
      ) {
        if (stryMutAct_9fa48('471')) {
          ...
          throw new Error(
            stryMutAct_9fa48('472')
              ? ``
              : (stryCov_9fa48('472'), `Template not found: ${templateName}`)
          );
        }
      }
      ...
      for (const [key, value] of Object.entries(variables)) {
        if (stryMutAct_9fa48('473')) {
          ...
          result = result.replace(
            new RegExp(
              stryMutAct_9fa48('474') ? `` : (stryCov_9fa48('474'), `{{${key}}}`),
              stryMutAct_9fa48('475') ? '' : (stryCov_9fa48('475'), 'g')
            ),
            value
          );
        }
