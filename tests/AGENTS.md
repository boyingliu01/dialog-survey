...
> Auto-generated by `/init-deep` on 2026-06-18. 75 test files, ~828 tests.

## OVERVIEW
Vitest 4.x test suite with 80%+ coverage thresholds. Flat structure in `tests/` directory (75 files, ~828 tests).
